            ...
            <table class="w-full">
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                >
                  ...
                  <td
                    class="px-6 py-4 font-mono text-sm text-gray-600 select-all"
                  >
                    {{ client.client_name }}
                  </td>
                  <td class="px-6 py-4">
                    <p class="text-xs text-gray-500 truncate max-w-50">
                      {{ client.description || "-" }}
                    </p>
                  </td>
          ...
          <form @submit.prevent="handleCreateClient" class="p-8 space-y-6">
            <div>
              ...
              <input
                ...
                type="text"
                required
                placeholder="e.g., NovaPay iOS App"
            ...
            <div>
              ...
              <input
                ...
                type="text"
                required
                placeholder="e.g., NovaPay Co., Ltd."
                class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
              />
              <p class="text-xs text-gray-500 mt-1">
                Must match the Organization (O) in CSR.
              </p>
            </div>
...
const handleCreateClient = async () => {
  ...
  try {
    await createClient({
      ...
      scope: formData.value.selectedScopes.join(" "),
    });
