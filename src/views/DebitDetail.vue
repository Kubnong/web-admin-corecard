<template>
  <MainLayout>
    <div class="flex flex-col lg:flex-row gap-8 mb-10">
      <div
        class="w-full lg:w-[400px] h-[240px] rounded-2xl bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-800 text-white p-6 relative shadow-xl flex flex-col justify-between overflow-hidden"
      >
        <div
          class="absolute top-0 right-0 -mr-10 -mt-10 w-40 h-40 bg-white opacity-10 rounded-full blur-2xl"
        ></div>
        <div
          class="absolute bottom-0 left-0 -ml-10 -mb-10 w-40 h-40 bg-blue-400 opacity-20 rounded-full blur-xl"
        ></div>
        ...
        <div class="z-10 mt-4">
            ...
            <div class="flex items-center gap-2">
              ...
              <div @click="handleGetSensitiveData(cardData?.cardId)">
                <svg
                  ...
                  class="h-5 w-5 opacity-70 cursor-pointer"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div
            v-else class="flex items-center gap-4 text-2xl tracking-widest font-mono"
          >
            <span>••••</span>
            <span>••••</span>
            <span>••••</span>
        ...
        <div class="flex justify-between items-end z-10">
          ...
          <div class="flex flex-col items-end">
            ...
            <div class="flex relative">
              ...
              <div
                class="w-8 h-8 bg-yellow-500 rounded-full opacity-90 -ml-4"
              ></div>
            </div>
          </div>
        </div>
      ...
      <div
        class="flex-1 bg-white p-8 rounded-xl shadow-sm border border-gray-100"
      >
        <div
        ...
        >
          ...
          <div>
            ...
            <p class="text-gray-500 text-sm">
              {{ cardData?.current_spending_limit }}
            </p>
          </div>
          ...
          <div>
            <h3 class="font-bold text-gray-900 mb-1">
              Status :
              <span
                class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-green-100 text-green-800"
              >
                Active
              </span>
            </h3>
